  ...
  styleUrls: ['./purchase-product.component.css'],
   standalone: true,
    imports: [
        ...
        providers: [MessageService, ProductService, ConfirmationService,CategoryService,BarcodeService,VendorService]
})
...
generate(data:any) {
 ...
 toggleFieldsBasedOnVendor(vendorName: string): void {
    ...
    const purchasePriceControl = this.productForm.get('purchasePrice');
...
sumTotal(): number {
  ...
  get isSaveDisabled(): boolean {
    return !this.vendorName?.value || !this.productForm.valid;
  }
