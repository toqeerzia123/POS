...
{
    public abstract class IPOCWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static IPOCWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(IPOCWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<IPOCDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<IPOCDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<IPOCDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<IPOCDbContext, Task<T>> func)
        {
            T result;
